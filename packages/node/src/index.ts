...
async function main() {
    const config = {
        ...
        didMethodName: 'sidetree.testnet',
    ...
    app.get('/1.0/transactions', async (req, reply) => {
    ...
    app.listen(SERVICE_PORT, SERVICE_HOST, (err, port) => console.log(`server is running ${port}`))
}
